...
## {#metodos11 data-menu-title="Metodologia: Tamanho da amostra"}
...
O número de UPAs selecionado é calculado considerando fixo o número de domicilios selecionados por cada UPA, representado por $\bar{x}$, gerando a seguinte expressão
$$
m = -\frac{N \cdot \sum_{h=1}^H \sum_{i=1}^{M_h} \left[ N_{\tilde{h}i} \cdot \left( \widetilde{Y}_{\tilde{h}i}^2 - \widetilde{Y}_{\tilde{h}}^2 \right) - \left[ \left( \frac{N_{\tilde{h}i} - n_{\tilde{h}i}^*}{n_{\tilde{h}i}^*} \right) \cdot \left( 1 - \frac{N_{\tilde{h}i}}{N_{\tilde{h}}} \right) - \left( \frac{N_{\tilde{h}i} - \bar{n}}{\bar{n}} \right) \right] \cdot {\bf s}_{\hat{\bf y}\tilde{h}i}^2 \right]}{\left( CV(\hat{Y}) \cdot \hat{Y} \right)^2}
$$

Onde:

- $CV(\hat{Y})$ é o coeficiente de variação desejado para a estimativa de interesse;
- $\hat{Y}$ é a estimativa do total da característica de interesse adquiridas no Censo 2022.

:::

---

## {#metodos12 data-menu-title="Metodologia: Alocação do tamanho da amostra"}
...
## {#metodos13 data-menu-title="Metodologia: Ajustes no tamanho da amostra"}
...
## {#metodos14 data-menu-title="Metodologia: Seleção das unidades primárias de amostragem"}
...
## {#metodos15 data-menu-title="Metodologia: Seleção dos domicílios"}
...
## {#metodos16 data-menu-title="Metodologia: Cálculo dos pesos: UPAs"}
...
## {#metodos17 data-menu-title="Metodologia: Cálculo dos pesos: UPAs"}
...
## {#metodos18 data-menu-title="Metodologia: Cálculo dos pesos: domicílios"}
...
## {#metodos19 data-menu-title="Metodologia: Cálculo dos pesos: domicílios - peso básico"}
...
## {#metodos20 data-menu-title="Metodologia: Cálculo dos pesos: domicílios - com ajuste por não resposta"}
...
## {#metodos21 data-menu-title="Metodologia: Cálculo dos pesos: domicílios - peso ajustado por calibração"}
...
## {#metodos22 data-menu-title="Metodologia: Cálculo dos pesos: domicílios - peso ajustado por calibração"}
...
## {#metodos23 data-menu-title="Metodologia: Outros estimadores"}
